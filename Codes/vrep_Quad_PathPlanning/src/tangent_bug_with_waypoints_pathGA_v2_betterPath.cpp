...
//	return pnt[*std::min_element(distances,distances+n)];
	...
	int main(int argc, char** argv)
	{
		...
		*/
			double small[33][3];
			double targets[33][3]=          {0,   46.0000,    3.5000,
         0,   31.0000,    3.5000,
         0,   16.0000,    3.5000,
         0,   16.0000,    3.0000,
    1.0000,   11.5000,    3.0000,
    2.0000,    7.0000,    3.0000,
    2.0000,    7.0000,    3.5000,
    1.5000,   41.5000,    3.5000,
    1.0000,   76.0000,    3.5000,
    1.0000,   76.0000,    3.5000,
   21.0000,   63.0000,    3.5000,
   41.0000,   50.0000,    3.5000,
   41.0000,   50.0000,    3.5000,
   42.0000,   33.0000,    3.5000,
   43.0000,   16.0000,    3.5000,
   43.0000,   16.0000,    3.5000,
   55.5000,   38.5000,    3.5000,
   68.0000,   61.0000,    3.5000,
   68.0000,   61.0000,    3.5000,
   57.0000,   76.5000,    3.5000,
   46.0000,   92.0000,    3.5000,
   46.0000,   92.0000,    3.5000,
   75.5000,   91.0000,    3.5000,
  105.0000,   90.0000,    3.5000,
  105.0000,   90.0000,    3.5000,
  103.0000,   73.0000,    3.5000,
  101.0000,   56.0000,    3.5000,
  101.0000,   56.0000,    3.5000,
   94.5000,   40.5000,    3.5000,
   88.0000,   25.0000,    3.5000,
   88.0000,   25.0000,    3.5000,
   96.0000,   13.0000,    3.5000,
  104.0000,    1.0000,    3.5000};
    // divide
			for (int r=0;r<aaa;r++)
			{
				for (int c=0;c<2;c++)
